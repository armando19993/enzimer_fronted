<template>
    <v-container fluid>
      <v-app-bar color="grey lighten-3" class="mb-4 mt-0" elevation="0">  
        <div>
          <span class="caption teal--text">Razonamiento Verbal</span>
          <h2 class="text--grey">
            Pregunta N° 20
          </h2>
        </div>
      ...
      <v-row>
        <v-col cols="12" md="5" lg="3" class="questions-box">
          <v-card dark class="grey darken-4 rounded"  elevation="0">
            ...
            <!-- Cajas -->
            <v-card-text>
              <v-row v-for="(item,index) in 4" :key="index" class="my-1" :class="index == 0 ? 'grey darken-3 rounded' : '' ">
                <v-col 
                  class="teal text-uppercase rounded text-center py-16" 
                  cols="2"
                >
                  <p class="my-5 h2"><v-icon>mdi-flask</v-icon></p>
                  <h2 class="my-5 h2">a</h2>
                  <h2 class="my-5 h2">b</h2>
                </v-col>
                <v-col 
                  cols="10"
                >
                  <v-row class="pl-1">
                    <v-col 
                      ...
                      cols="3"
                    >
                      <p style="width:50px;height:50px"  :class="item < 10 ? 'green' : 'red' " class="my-0 text-center rounded py-4 px-0">{{item+1}}</p>
                    </v-col>
                  </v-row>
                </v-col>
              </v-row>
        ...
        <v-col cols="12" md="7" lg="9">
          <v-card class="rounded pa-10" elevation="0">
            ...
            <v-card-text>
              <v-radio-group>
                <v-radio color="teal" class="my-3" v-for="item in 4" :key="item" :label="item+' Respuesta de la pregunta'" :value="item"></v-radio>
              </v-radio-group>
            </v-card-text>
            <!-- Saber mas -->
            <v-card-text class="mt-10">
              <v-card color="grey lighten-3" elevation="0">
                <v-card-title class="teal" primary-title>
